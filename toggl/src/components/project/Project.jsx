...
const Project = () => {
  ...
  const getdata = () => {
    axios
      .get("https://toggl-backend.herokuapp.com/project", {
        headers: {
          authorization: token,
        },
      })
  ...
  const handleSubmit = () => {
    ...
    onClose();
    axios
      .post("https://toggl-backend.herokuapp.com/project/create", payload, {
        headers: {
          authorization: token,
        },
      })
  ...
  const deletedata = (id) => {
    axios
      .delete(`https://toggl-backend.herokuapp.com/project/delete/${id}`, {
        headers: {
          authorization: token,
        },
      })
