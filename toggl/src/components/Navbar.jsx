...
const Navbar = () => {
    return (
        <HStack fontSize={'1.15rem'} className={styles.Navbar} p='1.6rem 2rem' align='center' w='100%' color='white' justify={'space-between'}>
            ...
            <HStack spacing={'1.8rem'} className={styles.right} display='flex'>
                ...
                <Divider orientation='vertical' height='32px' border={'1.5px solid white'} background={'white'} />
                <Box>
                    <Text>
                        <a href="#">
                            Log in
